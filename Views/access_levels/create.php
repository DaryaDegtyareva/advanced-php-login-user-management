	...
	<div class="container">
		<div class="row">
			...
			<div class="card">
				...
				<h3 class="card-title">Add New Privileges Group</h3><div class="card-options">
				  <a href="<?php echo base_url("access_levels");?>" class="btn btn-secondary ml-2"><i class="fa fa-chevron-left"></i> &nbsp;&nbsp;Back</a>
				</div>
				
				</div>
				<form action="<?php echo base_url("access_levels/create"); ?>" method="POST">
				<div class="card-body">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="input-group-append" style="flex: 2">
										<input type="number" class="form-control" name="max_connections" placeholder="Number of active sessions.." value="" disabled >
									</div>
									</div>
								</div>
								<div class="col-md-6">
									...
									<div class="input-group-append" style="flex: 2">
										<input type="text" class="form-control" name="default_index" placeholder="Index page URL (http://...)" value="" disabled >
									</div>
									</div>
								</div>
							</div>
							...
							<div class="card">
								...
								<div class="card-body">
									<?php  foreach($sections as $k => $v) { ?><label class="custom-control custom-checkbox ">
										<input type="checkbox" class="custom-control-input" name="privileges[]" value="<?php echo $v; ?>">
							...
							<div class="card">
								...
								<div class="card-body">
									<?php  foreach($pages as $k => $v) { ?><label class="custom-control custom-checkbox ">
										<input type="checkbox" class="custom-control-input" name="privileges[]" value="<?php echo $v; ?>.read">
										<span class="custom-control-label"><?php echo $v; ?></span>
									  </label><?php } ?>
								</div>
							</div>
				...
				<div class="card-footer text-right">
				  <div class="d-flex">
					<button type="submit" name="add_group" class="btn btn-primary ml-auto">Add Privileges Group</button>
				  </div>
				</div>
				<?php 
